  ...
  return (
    <div className='pt-6'>
      ...
      {!sucess && <div className='w-1/5 mx-auto'>
        ...
        <input type='text' 
              className='p-10 bg-blue-100 focus:outline-none focus:shadow-outline border border-gray-300 my-3 rounded-lg py-2 px-4 block w-full appearance-none leading-normal' 
              placeholder='Nome' 
              onChange={onChange} name='Nome' 
              value={form.Nome} />

        <label className='font-bold'>E-mail:</label>
        <input class='p-10 bg-blue-100 focus:outline-none focus:shadow-outline border border-gray-300 my-3 rounded-lg py-2 px-4 block w-full appearance-none leading-normal' 
                type="email" 
        ...
        <button className='p-10 my-3 bg-blue-400 px-12 py-4 font-bold rounded-lg shadow-lg hover:shadow' onClick={save}>Salvar</button>
      </div>}
      {sucess && <div className='w-1/5 mx-auto'>
